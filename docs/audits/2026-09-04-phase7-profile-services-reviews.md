...
**التاريخ:** ٢٠٢٦-٠٩-٠٤ (مساءً) · **الفرع:** `main` ثم `owner-edits` · **الترحيل:** [`20260907_phase7_profile_services_reviews.sql`](../../supabase/migrations/20260907_phase7_profile_services_reviews.sql) — **شُغِّل على الإنتاج في ٥ سبتمبر ✓ (تحقّق مباشر)**.
...
* الترحيل **شُغِّل على الإنتاج في ٥ سبتمبر ✓**: حتى يُشغَّل، تبويبا الخدمات والتقييمات يعرضان «تعذّرت
