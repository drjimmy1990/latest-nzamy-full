...
**الفرع:** `main` ثم `owner-edits`. **الترحيلات الجديدة (نُفِّذت على الإنتاج في ٥ سبتمبر ✓):** `20260909_document_shares_hashes.sql` · `20260910_case_notes.sql` · `20260911_community_reports.sql` — كلها اختُبرت في حاضنة Docker (RLS) قبل الدفع، ونُفِّذت على الإنتاج في ٥ سبتمبر ✓.
