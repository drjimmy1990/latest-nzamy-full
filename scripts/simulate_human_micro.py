...
Target Actor:
  ...
  Email: default below, override via env UAT_MICRO_EMAIL
...
MICRO_EMAIL = os.environ.get("UAT_MICRO_EMAIL", "micro-owner.uat-20260915-full@nzamy.test")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Simulate Human Micro Business (SME) Behavior")
