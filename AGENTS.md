...
This project is indexed by GitNexus as **latest-nzamy-full** (10551 symbols, 19894 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
