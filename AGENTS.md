...
This project is indexed by GitNexus as **latest-nzamy-full** (9388 symbols, 18231 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
