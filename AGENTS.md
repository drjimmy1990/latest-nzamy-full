...
This project is indexed by GitNexus as **latest-nzamy-full** (14327 symbols, 28122 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
