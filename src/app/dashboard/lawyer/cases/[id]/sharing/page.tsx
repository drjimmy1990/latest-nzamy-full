...
export default function CaseSharingPage() {
  return (
    <DashboardComingSoon
      ...
      description="لوحة التحكم في ما يراه الموكل من قضيته — روابط الضيف، نطاق المشاركة، والجدول الزمني — قيد التطوير. سيتم تفعيلها فور ربط مخزن المشاركة بقاعدة البيانات؛ حتى ذلك الحين لا تُحفظ إعدادات المشاركة."
