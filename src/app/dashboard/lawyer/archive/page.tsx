...
import {
  ...
  Clock, Buildings, Tag, CalendarBlank, ArrowUpRight, Warning,
    ...
    <div className="max-w-[1000px] mx-auto space-y-5" dir="rtl">
      ...
      <motion.div initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div>
          ...
          <p className={`text-[11px] ${isDark ? "text-zinc-500" : "text-amber-600/60"}`}>الأرشيف سيعرض البيانات الحقيقية قريباً</p>
        </div>
      </motion.div>
