              ...
              {step === 1 && BACKEND_MODE === "supabase" && googleSignUpWorks && (
                <div className="mt-6">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white py-3.5 text-sm font-semibold text-ink transition-all disabled:opacity-40 hover:border-slate-300 dark:border-white/10 dark:bg-dark-card"
                  >
