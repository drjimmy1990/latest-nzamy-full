...
const sections = {
  ar: [
    { icon: Info,        title: "طبيعة نظامي AI",           color: "bg-royal/5 text-royal",          body: "نظامي AI هو مساعد قانوني ذكي مدرَّب على الأنظمة والتشريعات السعودية. هو أداة إرشادية تعليمية مصممة لمساعدتك على فهم حقوقك والخيارات المتاحة أمامك — وليس مصدراً لقرارات قانونية ملزمة." },
    { icon: Lock,        title: "خصوصية محادثاتك",          color: "bg-emerald-50 text-emerald-700",  body: "جميع المحادثات مع نظامي AI مشفّرة ولا تُشارَك مع أطراف خارجية دون موافقتك. لا يُحتفظ بسجل محادثاتك بعد انتهاء الجلسة إلا إذا اخترت تفعيل حفظ السجل في إعداداتك." },
    { icon: Warning,     title: "حدود الموثوقية",            color: "bg-amber-50 text-amber-700",      body: "رغم أن نظامي AI يسعى لتقديم معلومات دقيقة، فإن التشريعات تتغير باستمرار. تحقق دائماً من المصادر الرسمية أو استشر محامياً مرخصاً قبل اتخاذ أي قرار قانوني مهم." },
    { icon: Scales,      title: "مسؤولية الاستخدام",        color: "bg-slate-50 text-slate-700",      body: "لا تتحمل منصة نظامي أي مسؤولية قانونية أو مدنية تجاه أي ضرر ينشأ عن الاعتماد على مخرجات نظامي AI باعتبارها استشارة قانونية قاطعة." },
    { icon: ChatCircle,  title: "التصعيد لمحامٍ متخصص",   color: "bg-gold/5 text-gold-dark",        body: "في أي لحظة يمكنك طلب التصعيد الفوري لمحامٍ متخصص معتمد عبر المنصة. نوصي بذلك في قضايا: الجنايات، النزاعات العمالية المعقدة، قضايا الأحوال الشخصية." },
    { icon: FileText,    title: "الاستخدامات المقبولة",      color: "bg-purple-50 text-purple-700",   body: "يُحظر استخدام نظامي AI لأغراض احتيالية أو لانتهاك حقوق الآخرين أو لأي غرض مخالف للأنظمة السعودية." },
  ],
  en: [
    { icon: Info,       title: "Nature of Nezamy AI",             color: "bg-royal/5 text-royal",          body: "Nezamy AI is an intelligent legal assistant trained on Saudi laws and regulations. It is an educational and guidance tool — not a source of binding legal decisions." },
    { icon: Lock,       title: "Privacy of Your Conversations",   color: "bg-emerald-50 text-emerald-700",  body: "All conversations with Nezamy AI are encrypted and not shared with external parties without your consent." },
    { icon: Warning,    title: "Reliability Limits",               color: "bg-amber-50 text-amber-700",      body: "While Nezamy AI strives for accuracy, legislation changes constantly. Always verify through official sources or consult a licensed lawyer." },
    { icon: Scales,     title: "Usage Responsibility",             color: "bg-slate-50 text-slate-700",      body: "Nezamy platform bears no legal or civil liability for any harm arising from relying on Nezamy AI outputs as definitive legal advice." },
    { icon: ChatCircle, title: "Escalation to a Specialist Lawyer",    color: "bg-gold/5 text-gold-dark",        body: "At any moment you can request immediate escalation to a certified specialist lawyer through the platform." },
    { icon: FileText,   title: "Acceptable Use",                   color: "bg-purple-50 text-purple-700",   body: "It is prohibited to use Nezamy AI for fraudulent purposes, to violate others' rights, or for any purpose contrary to Saudi regulations." },
  ],
};
      ...
      <main className="bg-surface dark:bg-dark-bg transition-colors duration-300">
        ...
        <section className="relative overflow-hidden pb-20 pt-32 md:pt-40">
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute -top-20 left-1/2 h-[500px] w-[700px] -translate-x-1/2 rounded-full opacity-10"
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm leading-relaxed text-amber-800 dark:text-amber-300">
                  {isAr
                    ? "المعلومات المقدمة من نظامي AI هي لأغراض إعلامية وتعليمية فقط، ولا تُعدّ استشارةً قانونيةً ملزمة."
                    : "Information provided by Nezamy AI is for informational and educational purposes only."}
                </p>
              </div>
            </motion.div>
          </div>
              ...
              <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                ...
                <ul className="space-y-3">
                  {canDoList.map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-sm text-ink-muted dark:text-gray-400">
        ...
        {/* Sections */}
        <section className="pb-16 md:pb-24">
          <div className="mx-auto max-w-[860px] px-4 space-y-4">
          ...
          <div className="mx-auto max-w-[860px] px-4">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <p className="mx-auto mt-3 max-w-[44ch] text-sm leading-relaxed text-white/70">
                {isAr ? "تواصل مع أحد محامينا المعتمدين مباشرة — استشارة أولى خلال ١٥–٢٠ دقيقة." : "Connect directly with one of our certified lawyers — first consultation within 15–20 minutes."}
              </p>
              <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
                <motion.a href="/services/consultations" whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
                  className="inline-flex items-center gap-2 rounded-2xl bg-white px-7 py-3.5 text-sm font-bold text-royal">
                  {isAr ? "احجز استشارة" : "Book a Consultation"}
                  <ArrowLeft size={15} weight="bold" />
                </motion.a>
                <a href="/faq" className="inline-flex items-center gap-2 rounded-2xl border border-white/20 px-7 py-3.5 text-sm font-medium text-white/80 hover:border-white/40 hover:text-white transition-all">
                  <Question size={15} />
