...
const FIRM_ROLE_ALLOWED_ITEMS: Record<AffiliationRole | "default", string[]> = {
  ...
  lawyer: ["Overview", "All Cases", "Hearings", "Team Tasks", "Contract Manager", "Templates", "Documents", "Unified Archive", "Clients", "Consultations", "Conflict Check", "ParaLegal (AI Briefing)", "Quick Legal Q&A", "Legal Drafter", "Contract Pro", "My AI Orders", "Contract Reviewer", "Doc Analyzer", "Court Guide", "AI Secretary", "Legal Calculator", "Direction Support", "Legal Translator", "Smart Comparator", "Circuits & Emails", "Shared Rooms", "Legal Blog", "Legal Library", "Nezamy Academy", "Notifications", "Settings"],
  legal_consultant: ["Overview", "All Cases", "Team Tasks", "Contract Manager", "Documents", "Clients", "Consultations", "Conflict Check", "Quick Legal Q&A", "Legal Drafter", "My AI Orders", "Contract Reviewer", "Doc Analyzer", "Legal Library", "Notifications", "Settings"],
  in_house_counsel: ["Overview", "All Cases", "Team Tasks", "Contract Manager", "Documents", "Clients", "Consultations", "Conflict Check", "Quick Legal Q&A", "Legal Drafter", "My AI Orders", "Contract Reviewer", "Doc Analyzer", "Legal Library", "Notifications", "Settings"],
  trainee: ["Overview", "Hearings", "Team Tasks", "Templates", "Documents", "Unified Archive", "Quick Legal Q&A", "Legal Drafter", "My AI Orders", "Court Guide", "Legal Calculator", "Legal Library", "Nezamy Academy", "Notifications", "Settings"],
  ...
  external_of_counsel: ["Overview", "All Cases", "Hearings", "Team Tasks", "Documents", "Shared Rooms", "Quick Legal Q&A", "Legal Drafter", "My AI Orders", "Doc Analyzer", "Legal Library", "Notifications", "Settings"],
  default: ["Overview", "All Cases", "Hearings", "Team Tasks", "Contract Manager", "Documents", "Clients", "Consultations", "Quick Legal Q&A", "Legal Drafter", "Contract Pro", "My AI Orders", "Doc Analyzer", "Legal Library", "Notifications", "Settings"],
};
